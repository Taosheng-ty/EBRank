...
class PairwisePreferenceMultileave(object):
    """_summary_ class to carry out multileave.
    ...
    def make_multileaving(self, descending_rankings, inverted_rankings):
        """_summary_  multileave the results

        Args:
            descending_rankings (_type_): _description_
            inverted_rankings (_type_): _description_
    ...
    def infer_preferences(self, result_list, clicked_docs):
        """_summary_ analysis the results to get which explored ranker is better.

        Args:
            result_list (_type_): _description_
            clicked_docs (_type_): _description_
