...
root_path="localOutput/July16MQ2007"
...
for NewItemEnterProb in NewItemEnterProbs:
        ...
        # list_settings={"ExpandFeature":['True','False'],"Ranker":['TD_DBGD', 'PDGD',"TD_MGD"],\
        #         "NewItemEnterProb":[NewItemEnterProb],"random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)
        # list_settings={"ExpandFeature":['False'],"Ranker":["NNTopK"],\
        #         "NewItemEnterProb":[NewItemEnterProb],"random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)
        # ##write setting.json for 'FairCo', 'FairCo_multip.','FairCo_average'
        # list_settings={'positionBiasSeverity':positionBiasSeverity,"ExpandFeature":['False'],"Ranker":["UCBRank"],"exploreParam":[0,1,10],\
        #         "NewItemEnterProb":[NewItemEnterProb],"random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)  
