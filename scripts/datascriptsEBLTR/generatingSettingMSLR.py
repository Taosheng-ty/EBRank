...
dataset_dictBase={"MQ2008":{"n_iteration":728*20},"MQ2007":{"n_iteration":1643*35},\
        "MSLR-WEB30k_beh_rm":{"n_iteration":30995*(121-5)},"MSLR-WEB10k_beh_rm":{"n_iteration":9835*(122-5)}}
...
for NewItemEnterProb in NewItemEnterProbs:
        ...
        # ##write setting.json for 'FairCo', 'FairCo_multip.','FairCo_average'
        # list_settings={'positionBiasSeverity':positionBiasSeverity,"ExpandFeature":['False'],"Ranker":["EBRankOnlyBehaviour","EBRankOnlyPrior"],"exploreParam":[0],\
        #         "NewItemEnterProb":[NewItemEnterProb],"random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)
        ...
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)
        # ##write setting.json for 'FairCo', 'FairCo_multip.','FairCo_average'
        # list_settings={'positionBiasSeverity':positionBiasSeverity,"ExpandFeature":['False'],"Ranker":["EBRankV1"],"exploreParam":[0,0.1,1.0,10.0,100.0,1000.0],\
        #         "NewItemEnterProb":[NewItemEnterProb], "random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)
        ...
        # ##write setting.json for 'FairCo', 'FairCo_multip.','FairCo_average'
        # list_settings={'positionBiasSeverity':positionBiasSeverity,"ExpandFeature":['True', 'False'],"Ranker":["NNEpsilon"],"exploreParam":[1],\
        #         "NewItemEnterProb":[NewItemEnterProb],"random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)

        # list_settings={"ExpandFeature":['False'],"Ranker":["TS"],\
        #         "NewItemEnterProb":[NewItemEnterProb],"random_seed":[0,1,2,3,4]}
        # write_setting(datasets,list_settings,settings_base,NewDataset_dict)
